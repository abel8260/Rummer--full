...
if($item1 =='no'){
echo '<img src="../../static/fundo.svg" style= "margin-left: 39vw; margin-top:13vh" class="imgmid" width="289vw" height="289vh">';
}else{
echo '<img src="../../static/open1.png" style= "margin-left: 39vw; margin-top:13vh" class="imgmid" width="289vw" height="289vh">';
}
?>
<br/>
<br/>
...
<a href="../keypoint_2/map2.php" ><img src="../../static/norte.svg"  class="imgmid" width="100vw" height="100vh"></a>
<a href="../keypoint_3/map3.php" ><img src="../../static/leste.svg" class="imgmid" width="100vw" height="100vh"></a>
<a href="../keypoint_4/map4.php" ><img src="../../static/sul.svg"  class="imgmid" width="100vw" height="100vh"></a>
<a href="../keypoint_5/map5.php" ><img src="../../static/oeste.svg" class="imgmid" width="100vw" height="100vh"></a>
</div>
<br/>
<br/>
<br/>
